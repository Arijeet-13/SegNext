...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
try:
    # Upstream repo uses a custom SyncBN implementation. For single-GPU (e.g. Kaggle P100),
    # BatchNorm2d is sufficient; this fallback keeps training runnable without extra copying.
    from sync_bn.nn.modules import SynchronizedBatchNorm2d  # type: ignore

    norm_layer = partial(SynchronizedBatchNorm2d, momentum=float(config['SyncBN_MOM']))
except Exception:
    norm_layer = partial(nn.BatchNorm2d, eps=1e-5, momentum=float(config['BN_MOM']))
